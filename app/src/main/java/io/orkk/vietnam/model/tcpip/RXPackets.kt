...
class RXPackets {
    companion object {
        ...
        const val RECEIVE_COMMAND_GPS_ZONE_C: Int = 0x200d
        const val RECEIVE_COMMAND_PIN_COURSE: Int = 0x2101
        const val RECEIVE_COMMAND_FOOD_MENU: Int = 0x2105
        const val RECEIVE_COMMAND_NOTICE: Int = 0x2701
        ...
        enum class Packets(val commandName: String, val decimal: Int, val hexadecimal: Int) {
            ...
            GPS_ZONE_C("RECEIVE_COMMAND_GPS_ZONE_C", 8205, RECEIVE_COMMAND_GPS_ZONE_C),
            PIN_COURSE("RECEIVE_COMMAND_PIN_COURSE", 8449, RECEIVE_COMMAND_PIN_COURSE),
            FOOD_MENU("RECEIVE_COMMAND_FOOD_MENU", 8453, RECEIVE_COMMAND_FOOD_MENU),
            NOTICE("RECEIVE_COMMAND_NOTICE", 9985, RECEIVE_COMMAND_NOTICE),
